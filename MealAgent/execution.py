...
class MealPlannerAgent:
    ...
    def __init__(self, model):
        self.model = model
        self.logger =  logger.bind(node="MealPlannerAgent")
    ...
    def process_images(self, state: AgentState) -> AgentState:
        ...
        print(state, "type:", type(state), "current input:", state.current_conversation_input)
        ...
        print("images:", state.current_conversation_input.images)
